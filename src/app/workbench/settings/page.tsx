...
export default async function Settings(props: any) {
  ...
  const matchValue = pickSearchParam<ToString<TaskConfig['match']>>(props, 'match', '0');
  const inventoryValue = pickSearchParam<ToString<TaskConfig['inventory']>>(props, 'inventory', '0');
  const isLimitedValue = pickSearchParam<ToString<TaskConfig['isLimited']>>(props, 'isLimited', '0');
  const isPresellValue = pickSearchParam<ToString<TaskConfig['isPresell']>>(props, 'isPresell', '0');
