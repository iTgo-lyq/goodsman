...
export default function UsageModal() {
  ...
  return (
    ...
    >
      ...
      <TypographyParagraph>
        3.使用本软件进行商品复制时, 因不同电商平台规则不同, 部分属性平台会默认填上商品信息,
        复制后请认真核对商品信息是否有误 (包括但不限于专利号、专利类型、3C认证编号等信息),
        如果有误则应自行修改，避免因商品信息错误造成法律⻛险。若因没有核对商品信息真实性所造成的一切后果（包括但不限于被平台处罚、被职业打假人举报等）由软件使用者或使用者单位承担，与本软件制作方和运营方无关。
      </TypographyParagraph>
      <TypographyParagraph>
